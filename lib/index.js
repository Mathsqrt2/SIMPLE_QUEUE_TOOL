    ...
    cs.evalScript(`loadConfiguration('${cs.getSystemPath(SystemPath.EXTENSION)}')`,function(res){
        ...
        switch(config.applyFor){
            ...
            case "selected sequences":
                renderRange.value = renderRange.options[2].value;
                break;
        }
        ...
        switch(config.encodingPreset){
            case "h.264 | 64mbps | 384kbps":
                encodingPreset.value = encodingPreset.options[0].value;
                break;
            case "h.264 | 15mbps | 384kbps":
                encodingPreset.value = encodingPreset.options[1].value;
                break;
            case "h.264 | 64mbps | no audio":
                encodingPreset.value = encodingPreset.options[2].value;
                break;
            case "h.264 | 15mbps | no audio":
                encodingPreset.value = encodingPreset.options[3].value;
                break;
            case "vp9 | quality 60% | 384kbps":
                encodingPreset.value = encodingPreset.options[4].value;
                break;
            case "vp9 | quality 90% | 384kbps":
                encodingPreset.value = encodingPreset.options[5].value;
                break;
            case "vp9 | quality 60% | no audio":
                encodingPreset.value = encodingPreset.options[6].value;
                break;
            case "vp9 | quality 90% | no audio":
                encodingPreset.value = encodingPreset.options[7].value;
                break;
            case "quicktime | alpha | audio on":
                encodingPreset.value = encodingPreset.options[8].value;
                break;
            case "quicktime | alpha | audio off":
                encodingPreset.value = encodingPreset.options[9].value;
                break;
            case "custom":
                encodingPreset.value = encodingPreset.options[0].value;
                cs.evalScript(`getNewPreset('${cs.getSystemPath(SystemPath.EXTENSION)}')`);
